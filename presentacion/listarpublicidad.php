...
<title>Listar Publicidad</title>
<h1>Listado de publicidades del sitio</h1>
  ...
  <div>
      ...
      <div>
        <div class="news-letter">
          <form action="#" method="post">
            ...
            <input type="text" placeholder="ID" id="name" />
            <input type="text" placeholder="Tamaño" id="name" />
            <input type="text" placeholder="Tipo" id="email" />
            <input type="text" placeholder="Sección" id="name" />
    ...
    <div class="rigth_coloum floatleft">
      ...
      <h3>Resultado busqueda:</h3>
        ...
        <p>Tamaño: 120x50</p>
        <p>Tipo: Estatico </p>
        <p>Sección: Sector derecho1 </p>
        <p>Costo: $200 Mensual</p>
